...
export default class ClockIndex extends React.Component {
    ...
    componentDidMount() {
        ...
        setInterval(() => {  //used for real time clock 
            this.getTime();    
        }, 1000);
    ...
    getTime() {
        ...
        this.applyStyle(hourHand, hrPosition);
        this.applyStyle(minuteHand, minPosition);
        this.applyStyle(secondHand, secPosition);
    }

    applyStyle(handType, position) {
        handType.style.transform = `rotate(${position}deg)`;
    }
